...
function printList(searchResultData) {
    ...
    if (searchResultData.length === 0) {
        ...
        resultSearch.innerHTML = `<h1>데이터 <span class="blue">0</span>건이 검색되었습니다.</h1>`;
        // 비용금액 버튼 내용 초기화
    ...
    let start = new Array(searchResultData[0].drvDate, searchResultData[0].drvClub)[firstThFlag];
