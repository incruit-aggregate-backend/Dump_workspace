					...
					if (t.buttons || t.buttons != null) {
						...
						switch (t.type) {
							case "alert":
								...
								break;
							case "confirm":
								c = '<a style="font-size: 15px;" class="modal-btn' + (t.buttons[0].addClass ? " " + t.buttons[0].addClass : "") + '">' + a.cancel + '</a><a style="font-size: 15px;" class="modal-btn ' + (t.buttons[1] && t.buttons[1].addClass ? " " + t.buttons[1].addClass : "btn-light-blue") + '">' + a.yes + "</a>";
								break;
							case "prompt":
